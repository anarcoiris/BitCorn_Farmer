...
def main():
    ...
    parser.add_argument("--data", type=str, default="data_manager/exports/Binance_BTCUSDT_1h.db")
    parser.add_argument("--seq-len", type=int, default=32)
    parser.add_argument("--horizon", type=int, default=4)
    parser.add_argument("--hidden", type=int, default=96, help="Hidden size (increased from 92)")
