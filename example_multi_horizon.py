...
def run_example():
    ...
    DATA_PATH = "data_manager/exports/Binance_BTCUSDT_1h_fix.db"  # SQLite database

    # Prediction parameters
    N_PREDICTIONS = 500  # Number of predictions to generate
    ...
    # Example: -564 = -(N_PREDICTIONS + seq_len) starts 500 predictions before end
    START_IDX = -564  # Start near end of dataset for October 2025 predictions
